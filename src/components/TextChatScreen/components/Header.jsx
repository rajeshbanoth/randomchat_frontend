...
const Header = ({
  ...
  // Don't render fixed header when keyboard is visible on mobile
  if (isMobile && keyboardVisible) {
    return (
      // Return minimal header when keyboard is open
    ...
    <>
      ...
      <header 
        className={`
          ...
          px-4 md:px-6 py-3 md:py-4 
          border-b border-gray-800/30 
          bg-gradient-to-b from-gray-900/95 via-gray-900/95 to-gray-900/90 backdrop-blur-xl
          transition-all duration-200
        `}
        style={{
          // Use safe-area-inset for notched phones

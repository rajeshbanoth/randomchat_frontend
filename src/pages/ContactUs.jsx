// src/pages/ContactUs.jsx (Updated for Nodemailer with SEO)
...
const ContactUs = () => {
  ...
  // SEO Data
  const pageTitle = "Contact Omegle Pro Support | 24/7 Customer Service & Help Center";
  const pageDescription = "Get 24/7 support from Omegle Pro's customer service team. Contact us for technical support, safety reports, billing questions, or partnership inquiries.";
  const pageKeywords = "Omegle Pro contact, customer support, technical help, random chat support, video chat help, text chat assistance, omegle alternative support";
  const canonicalUrl = "https://omeglepro.vercel.app/contact";
  const pageSchema = {
    "@context": "https://schema.org",
    "@type": "ContactPage",
    "name": "Omegle Pro Contact & Support",
  ...
  const generateFAQSchema = () => ({
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "How long does it take to get a response from Omegle Pro support?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "We guarantee a response within 24 hours for normal priority inquiries. Urgent safety issues are addressed within 2 hours. Emergency support is available 24/7 via email at rajibanavath@zohomail.in"
        }
      },
      {
        "@type": "Question",
        "name": "What types of support does Omegle Pro provide?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Omegle Pro provides comprehensive support including technical assistance for video/chat issues, safety reports, billing questions, feature suggestions, partnership inquiries, legal matters, press/media requests, and career opportunities."
        }
      },
      {
        "@type": "Question",
        "name": "Is my information secure when contacting Omegle Pro support?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes, all communications are encrypted end-to-end. We never share your personal information with third parties without your consent and comply with GDPR and DPDP Act regulations."
        }
      },
      {
        "@type": "Question",
        "name": "Can I get help with random chat or video chat issues?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Absolutely! Our technical support team specializes in resolving random video chat and text chat issues, connection problems, webcam troubleshooting, and platform performance optimization."
        }
      },
      {
        "@type": "Question",
        "name": "How do I report a safety concern or inappropriate behavior?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Use our 'Safety Report' contact option or email rajibanavath@zohomail.in directly. Provide details like username, date/time, and description of the incident for immediate action."
        }
      }
    ]
  });
  ...
  const generateBreadcrumbSchema = () => ({
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "item": "https://omeglepro.vercel.app/contact"
      }
    ]
  });
  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta name="author" content="Omegle Pro Support Team" />
        ...
        <meta property="og:image" content="https://omeglepro.vercel.app/contact-og-image.jpg" />
        ...
        <meta name="twitter:image" content="https://omeglepro.vercel.app/contact-twitter-card.jpg" />
        ...
        {/* Additional Structured Data for Customer Service */}
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Service",
              ...
              "itemListElement": [
                {
                  ...
                  "itemOffered": {
                    ...
                    "description": "Get help with video chat, text chat, and platform technical issues"
                  }
                },
                {
                  "@type": "Offer",
                  "itemOffered": {
                    "@type": "Service",
                    "name": "Safety Support",
                    "description": "Report safety concerns and get help with moderation issues"
                  }
                },
                {
                  "@type": "Offer",
                  "itemOffered": {
                    ...
                    "description": "Get assistance with payments, refunds, and subscription questions"
                  }
                }
              ]
            }
      ...
      <div className="hidden">
        <h1>Omegle Pro Support Center</h1>
        <h2>Contact Omegle Pro Customer Service</h2>
        <p>Get help with Omegle Pro random video chat platform. Contact our support team for technical assistance, safety reports, billing questions, or partnership inquiries about our omegle alternative service.</p>
        <ul>
          <li>Omegle Pro Support Contact</li>
          <li>Random Video Chat Help</li>
          <li>Text Chat Platform Support</li>
          <li>Omegle Alternative Customer Service</li>
          <li>Video Chat Technical Support</li>
          <li>Anonymous Chat Platform Help</li>
          <li>24/7 Chat Support</li>
          <li>Online Chat Troubleshooting</li>
        </ul>
      </div>
            ...
            <div className="text-center max-w-4xl mx-auto">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-4">
                <span className="bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-400 bg-clip-text text-transparent">
                  Contact Omegle Pro Support
                </span>
              </h1>
              <p className="text-xl text-gray-300 mb-6">
                24/7 Customer Support for Random Video Chat & Text Chat Platform
              </p>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1 space-y-8">
              ...
              <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-6 border border-gray-700">
                ...
                <div className="space-y-4">
                  <a href="mailto:rajibanavath@zohomail.in" className="flex items-center space-x-3 p-3 bg-gray-800/50 rounded-lg hover:bg-gray-800 transition-colors group">
                    <div className="w-10 h-10 rounded-lg bg-gradient-to-r from-blue-500 to-cyan-500 flex items-center justify-center">
                      <FaEnvelope className="text-white" />
                    </div>
                    <div>
                      <div className="font-medium">Primary Support</div>
                      <div className="text-sm text-gray-400 group-hover:text-blue-400">rajibanavath@zohomail.in</div>
                    </div>
                  </a>
                  
                  <a href="mailto:banothrajesh1997@gmail.com" className="flex items-center space-x-3 p-3 bg-red-900/20 rounded-lg hover:bg-red-900/30 transition-colors group border border-red-500/30">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-400 group-hover:text-red-400">rajibanavath@zohomail.in</div>
                      <div className="text-xs text-red-400">Immediate Response</div>
                    </div>
                  </a>

                  <a href="mailto:banothrajesh1997@gmail.com" className="flex items-center space-x-3 p-3 bg-purple-900/20 rounded-lg hover:bg-purple-900/30 transition-colors group border border-purple-500/30">
                    <div className="w-10 h-10 rounded-lg bg-gradient-to-r from-purple-500 to-pink-500 flex items-center justify-center">
                      <FaGavel className="text-white" />
                    </div>
                    <div>
                      <div className="font-medium">Legal Department</div>
                      <div className="text-sm text-gray-400 group-hover:text-purple-400">rajibanavath@zohomail.in</div>
                    </div>
                  </a>
                </div>
              </div>
            ...
            <div className="lg:col-span-2">
              <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-6 md:p-8 border border-gray-700">
                <div className="flex items-center space-x-3 mb-6">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold">Send Message to Omegle Pro Support</h2>
                    <p className="text-gray-400">Get help with random video chat, text chat, or platform issues</p>
                  </div>
                </div>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-300">
                          Thank you for contacting Omegle Pro Support. We've received your message and will respond 
                          within <strong>{ticketInfo.estimatedResponse}</strong>.
                          A confirmation email has been sent to <strong>{formData.email}</strong>. Please check the spam folder if you don't see it in your inbox.
                        </p>
                  ...
                  <div className="pt-4">
                    ...
                    >
                      {isSubmitting ? (
                        ...
                        <>
                          <FaPaperPlane />
                          <span>Contact Omegle Pro Support</span>
                        </>
                      )}
                    </button>
            ...
            <div className="text-center">
              <div className="flex flex-col md:flex-row justify-between items-center mb-6">
                <div className="mb-4 md:mb-0">
                  ...
                  <p className="text-sm text-gray-400">24/7 Customer Service for Random Chat Platform</p>
                </div>
                <div className="flex space-x-4">
                  <a href="mailto:rajibanavath@zohomail.in" className="px-4 py-2 bg-gradient-to-r from-cyan-600 to-blue-600 rounded-lg hover:opacity-90 transition-all">
                    Email Support
                  </a>
              ...
              <div className="text-xs text-gray-500 space-y-2">
                ...
                <p>For emergencies requiring immediate attention, email rajibanavath@zohomail.in</p>
